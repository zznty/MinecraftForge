...
public class QuadHelper {
    public static void loadQuad(VertexDataBuilder bb, float x0, float x1, float y0, float y1, float u0, float u1, float v0, float v1, int colour) {
    ...
    public static void loadQuad(VertexDataBuilder bb, float x0, float x1, float y0, float y1, float u0, float u1, float v0, float v1) {
